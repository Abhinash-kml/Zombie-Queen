...
#define REGEX_STEAMID_PATTERN "^^STEAM_(0|1|2):(0|1):\d+$"
...
public plugin_init()
{
	...
	register_concmd("amx_ban", "CmdBan", 0, "amx_ban <nick, #userid, authid> <time in minutes> <reason>", -1);
	register_concmd("amx_banip", "CmdBanIp", 0, "amx_banip <nick, #userid, authid> <time in minutes> <reason>", -1);
	register_concmd("amx_addban", "CmdAddBan", 0, "amx_addban <name> <authid or ip> <time in minutes> <reason>", -1);
	register_concmd("amx_unban", "CmdUnban", 0, "amx_unban <authid or ip>", -1);
	register_concmd("amx_banlist", "CmdBanList", 0, "Shows banlist", -1);
