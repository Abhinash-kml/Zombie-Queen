...
public plugin_init()
{
	register_plugin("[AMXX] Settings API", "2.0", "MeRcyLeZZ + NeO")
}

public plugin_natives()
{
	register_library("SettingsAPI")
	register_native("AmxLoadInt", "native_load_setting_int")
	register_native("AmxLoadFloat", "native_load_setting_float")
	register_native("AmxLoadString", "native_load_setting_string")
	register_native("AmxSaveInt", "native_save_setting_int")
	register_native("AmxSaveFloat", "native_save_setting_float")
	register_native("AmxSaveString", "native_save_setting_string")
	register_native("AmxLoadIntArray", "native_load_setting_int_arr")
	register_native("AmxLoadFloatArray", "native_load_setting_float_arr")
	register_native("AmxLoadStringArray", "native_load_setting_string_arr")
	register_native("AmxSaveIntArray", "native_save_setting_int_arr")
	register_native("AmxSaveFloatArray", "native_save_setting_float_arr")
	register_native("AmxSaveStringArray", "native_save_setting_string_arr")
}
